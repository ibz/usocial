* Ability to play podcasts on the server (this could be used for example when running `usocial` on a home server, like [Umbrel](https://getumbrel.com/), that is connected to an audio system)
